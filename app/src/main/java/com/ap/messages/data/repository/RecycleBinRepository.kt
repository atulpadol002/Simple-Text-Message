...
import com.ap.messages.data.local.RecycleBinDatabaseHelper
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.COLUMN_ADDRESS
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.COLUMN_BODY
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.COLUMN_CACHED_DISPLAY_NAME
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.COLUMN_DATE
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.COLUMN_DELETED_AT
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.COLUMN_LOCAL_MESSAGE_ID
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.COLUMN_ORIGINAL_MESSAGE_ID
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.COLUMN_ORIGINAL_THREAD_ID
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.COLUMN_READ
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.COLUMN_RECYCLE_BIN_ID
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.COLUMN_RESTORED
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.COLUMN_SEEN
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.COLUMN_SENT_DATE
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.COLUMN_SERVICE_CENTER
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.COLUMN_STATUS
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.COLUMN_SUBSCRIPTION_ID
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.COLUMN_TYPE
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.TABLE_DELETED_CONVERSATIONS
import com.ap.messages.data.local.RecycleBinDatabaseHelper.Companion.TABLE_DELETED_MESSAGES

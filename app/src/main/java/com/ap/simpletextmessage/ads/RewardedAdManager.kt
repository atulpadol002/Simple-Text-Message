...
object RewardedAdManager {
    ...
    fun preload(context: Context, placement: AdPlacement) {
        ...
        val blockedReason = when {
            ...
            !AdSessionManager.canShowAd(config) -> "global_session_cap"
            else -> null
        }
            ...
            object : RewardedAdLoadCallback() {
                ...
                override fun onAdFailedToLoad(error: LoadAdError) {
                    ...
                    if (
                        ...
                        load(context, placement, AdLoadSource.BACKUP, revision)
                    } else {
                        loading -= placement
                    }
                }
    ...
    fun showOrFallback(
        ...
        val globalCapped = config.sessionMaxAds <= 0 ||
            AdSessionManager.snapshot.value.totalAdsShown >= config.sessionMaxAds
        ...
        val bypassReason = when {
            ...
            globalCapped -> "global_session_cap"
            else -> null
        }
